...
problems_data = [
    # ARRAY Problems (1-5)
    {
        ...
        'output_example': '[0, 1]',
        'tags': 'Array,HashTable,TwoPointers',
        'test_cases': [
            ('[2, 7, 11, 15]\n9', '[0, 1]'),
            ('[3, 2, 4]\n6', '[1, 2]'),
            ('[3, 3]\n6', '[0, 1]'),
    ...
    },
    {
        ...
        'input_example': '[3, 2, 3]',
        'output_example': '3',
        'tags': 'Array,DivideAndConquer,HashTable',
        'test_cases': [
            ('[3, 2, 3]', '3'),
            ('[2, 2, 1, 1, 1, 2, 2]', '2'),
            ('[1]', '1'),
    ...
    },
    {
        ...
        'output_example': '[2]',
        'tags': 'Array,HashTable,TwoPointers,BinarySearch',
        'test_cases': [
            ('[1,2,2,1]\n[2,2]', '[2]'),
            ('[4,9,5]\n[9,4,9,8,4]', '[4,9]'),
            ('[1,2]\n[2,3]', '[2]'),
    ...
    },
    {
        ...
        'tags': 'String,HashTable,Counting',
        'test_cases': [
            ('"a"\n"b"', 'false'),
            ('"a"\n"a"', 'true'),
            ('"aa"\n"ab"', 'false'),
    ...
    },
    {
        ...
        'output_example': '8',
        'tags': 'Array,Math,BitManipulation,HashTable',
        'test_cases': [
            ('[9,6,4,2,3,5,7,0,1]', '8'),
            ('[3,0,1]', '2'),
            ('[0,1]', '2'),
    ...
    },
    {
        ...
        'output_example': '6',
        'tags': 'Array,DynamicProgramming,TwoPointers,Stack',
        'test_cases': [
...
class Command(BaseCommand):
    help = 'Loads 30 problems with proper categories and tags'
    ...
    def handle(self, *args, **options):
        ...
        for problem_data in problems_data:
            try:
                ...
                created_count += 1
                self.stdout.write(
                    self.style.SUCCESS(f'✅ Added: {problem_data["title"]} ({problem_data["tags"]})')
                )
